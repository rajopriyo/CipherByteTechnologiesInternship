...
<title>ExamPage7</title>
<link rel="stylesheet" href="ExamPage7.css">  
<script>
  window.onload = function() {
    ...
    var x = setInterval(function() {
      ...
      if (distance < 1  ) {
          ...
          setTimeout(function() {
            window.location.href = "ExamPage8.jsp"; // Replace with your desired URL
...
<article>
  <div class="side_bar"> 
    ...
    <button class="question_1" >7</button>
    <button class="question" >8</button><br>
    <button class="question">9</button>
    <button class="question" >10</button><br>
  </div>
  
  <div class="ques"><b>Question 7:</b><br><br>
   What will be the output of the following Java code?<br><br>
...
<form action="ans7" method="post">
  <input class="radio_button" type="radio" value="true" name="ans">32<br>
  <input class="radio_button" type="radio" value="b" name="ans">33<br>
  <input class="radio_button" type="radio" value="c" name="ans">24<br>
  <input class="radio_button" type="radio" value="d" name="ans">25<br>
