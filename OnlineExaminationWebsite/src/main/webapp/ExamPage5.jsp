...
<link rel="stylesheet" href="ExamPage5.css">  
<script>
  window.onload = function() {
    ...
    var x = setInterval(function() {
      ...
      if (distance < 1  ) {
          ...
          setTimeout(function() {
            window.location.href = "ExamPage6.jsp"; // Replace with your desired URL
...
<article>
  <div class="side_bar"> 
    ...
    <button class="question_1">5</button>
  ...
  <div class="ques"><b>Question 5:</b><br><br>
...
<form action="ans5" method="post">
  <input class="radio_button" type="radio" value="a" name="ans">identifier & keyword<br>
  <input class="radio_button" type="radio" value="b" name="ans"> identifier<br>
  <input class="radio_button" type="radio" value="true" name="ans">  keyword<br>
  <input class="radio_button" type="radio" value="d" name="ans">none of the mentioned<br>
