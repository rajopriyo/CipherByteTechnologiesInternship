...
<link rel="stylesheet" href="ExamPage3.css">  
<script>
  window.onload = function() {
    ...
    var x = setInterval(function() {
      ...
      if (distance < 1  ) {
          ...
          setTimeout(function() {
            window.location.href = "ExamPage4.jsp"; // Replace with your desired URL
...
<article>
  <div class="side_bar"> 
    ...
    <button class="question_1" >3</button>
  ...
  <div class="ques"><b>Question 3:</b><br><br>
...
<article>
  <div class="side_bar1"> <br><br><br><br><br><br>
 
  </div>
  <div class="ans"><b>Options:</b><br><br>

<form action="ans3" method="post">
  <input class="radio_button" type="radio" value="a" name="ans">JRE<br>
  <input class="radio_button" type="radio" value="b" name="ans">JIT<br>
  <input class="radio_button" type="radio" value="true" name="ans">JDK<br>
  <input class="radio_button" type="radio" value="d" name="ans">JVM<br>
