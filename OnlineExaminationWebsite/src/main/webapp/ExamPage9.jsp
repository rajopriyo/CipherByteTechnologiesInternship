...
<title>ExamPage9</title>
<link rel="stylesheet" href="ExamPage9.css">  
<script>
  window.onload = function() {
    ...
    var x = setInterval(function() {
      ...
      if (distance < 1  ) {
          ...
          setTimeout(function() {
            window.location.href = "ExamPAge10.jsp"; // Replace with your desired URL
...
<article>
  <div class="side_bar"> 
    ...
    <button class="question_1">9</button>
    <button class="question" >10</button><br>
  </div>
  
  <div class="ques"><b>Question 9:</b><br><br>
   What will be the error in the following Java code?<br><br>
...
<form action="ans9" method="post">

  <input class="radio_button" type="radio" value="a" name="ans">b cannot contain value 50<br>
  <input class="radio_button" type="radio" value="b" name="ans"> b cannot contain value 100, limited by its range<br>
  <input class="radio_button" type="radio" value="c" name="ans">No error in this code<br>
  <input class="radio_button" type="radio" value="true" name="ans">* operator has converted b * 50 into int, which can not be converted to byte without casting<br>
