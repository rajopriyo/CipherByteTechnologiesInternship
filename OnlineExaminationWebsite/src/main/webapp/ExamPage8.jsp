...
<title>ExamPage8</title>
<link rel="stylesheet" href="ExamPage8.css">  
<script>
  window.onload = function() {
    ...
    var x = setInterval(function() {
      ...
      if (distance < 1  ) {
          ...
          setTimeout(function() {
            window.location.href = "ExamPage9.jsp"; // Replace with your desired URL
...
<article>
  <div class="side_bar"> 
    ...
    <button class="question_1" >8</button><br>
    <button class="question">9</button>
    <button class="question" >10</button><br>
  </div>
  
  <div class="ques"><b>Question 8:</b><br><br>
...
<form action="ans8" method="post">
  <input class="radio_button" type="radio" value="a" name="ans">MAVEN_Path<br>
  <input class="radio_button" type="radio" value="b" name="ans">JavaPATH<br>
  <input class="radio_button" type="radio" value="c" name="ans">JAVA<br>
  <input class="radio_button" type="radio" value="true" name="ans">JAVA_HOME<br>
